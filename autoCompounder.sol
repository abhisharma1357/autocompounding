...
contract PenguinStrategyGlobalVariables is Ownable {
    ...
    constructor(uint newPOOL_CREATOR_FEE_BIPS, uint newNEST_FEE_BIPS, uint newDEV_FEE_BIPS, uint newALTERNATE_FEE_BIPS, address newDevAddress, address newNestAddress, address newAlternateAddress) public {
 ...
 */
 contract PefiStrategy is PefiERC20, Ownable {
    ...
    */
     ...
     */
    function impromptuTokenAggregation(uint minReturnAmountAccepted, bool disableDeposits) external ;
...
interface IMasterChef {
 ...
 contract PefiStrategyForLP is PefiStrategy {
    ...
    */
    ...
    function impromptuTokenAggregation(uint minReturnAmountAccepted, bool disableDeposits) external  onlyOwner {
